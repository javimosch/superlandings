...
async function getAuditLogPaginated(landingId, { limit = 50, offset = 0 } = {}) {
  // Guard against NaN/negative from parseInt on invalid query params
...
const AUDIT_ACTIONS = {
  ...
  MOVE: 'move',
  CLOUDFLARE_CONNECT: 'cloudflare_connect',
  CLOUDFLARE_DISCONNECT: 'cloudflare_disconnect',
  CLOUDFLARE_DNS_CONFIGURE: 'cloudflare_dns_configure'
};
